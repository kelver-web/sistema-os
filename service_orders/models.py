...
class ServiceOrder(models.Model):
    ...
    estimated_cost = models.DecimalField(
        "Preço estimado", max_digits=10, decimal_places=2, null=True, blank=True
    )
    final_cost = models.DecimalField(
        "Preço final", max_digits=10, decimal_places=2, null=True, blank=True
    )
...
class ServiceTimeLine(models.Model):
    ...
    user = models.ForeignKey(
        settings.AUTH_USER_MODEL, on_delete=models.PROTECT, verbose_name="Usuário"
    )

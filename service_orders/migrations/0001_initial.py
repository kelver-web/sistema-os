    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ("PENDING", "Pendente"),
                            ("AWAITING_PARTS", "Aguardando peças"),
                            ("IN_PROGRESS", "Em andamento"),
                            ("AWAITING_APPROVAL", "Aguardando aprovação"),
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["status"], name="service_ord_status_a5c9d7_idx"
                    ),
                    models.Index(
                        fields=["technician", "status"],
                        name="service_ord_technic_087553_idx",
                    ),
                ],
            },
        ),

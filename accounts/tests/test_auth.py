...
def existing_user(db):
    return User.objects.create_user(username="testuser", email="testuser@teste", password="testpass")
...
class TestMeEndpoint:
    ...
    def test_me_com_token_valido_retorna_dados_do_usuario(self, api_client, existing_user):
        payload = {
            "username": "testuser",
            "password": "testpass",
        }
